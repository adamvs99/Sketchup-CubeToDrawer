    ...
    module DimensionsDialog
        ...
        class DimensionsInputs
            ...
            def _update_dialog_inputs
                ...
                simple_drawer_image = Utils::get_resource_file("simple_drawer.svg")
                pocket_screw_drawer_image = Utils::get_resource_file("pocket_screw_drawer.svg")
                dado_drawer_image = Utils::get_resource_file("dado_drawer.svg")
