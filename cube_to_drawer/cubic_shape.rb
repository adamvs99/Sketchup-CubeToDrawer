        ...
        class CubeMap
            ...
            def _prnt
                @_cube_map.each do |face, data|
                    puts face.ljust(10)   +   (data[:face_points][0]).to_s.ljust(22)
                    puts "".ljust(10) +   (data[:face_points][1]).to_s.ljust(22)
                    puts "".ljust(10) +   (data[:face_points][2]).to_s.ljust(22)
                    puts "".ljust(10) +   (data[:face_points][3]).to_s.ljust(22)
                end
            end
